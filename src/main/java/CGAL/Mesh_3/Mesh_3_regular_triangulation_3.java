...
package CGAL.Mesh_3;
import CGAL.Kernel.Point_3; import CGAL.Kernel.Weighted_point_3; import CGAL.Kernel.Bounded_side; import java.util.Iterator; import java.util.Collection;
public class Mesh_3_regular_triangulation_3 extends Internal_Triangulation_3_Mesh_3_regular_triangulation_3 {
  ...
  public Mesh_3_regular_triangulation_3_Vertex_handle nearest_power_vertex(Point_3 c) {
    return new Mesh_3_regular_triangulation_3_Vertex_handle(CGAL_Mesh_3JNI.Mesh_3_regular_triangulation_3_nearest_power_vertex__SWIG_0(swigCPtr, this, Point_3.getCPtr(c), c), true);
  }

  public void nearest_power_vertex(Point_3 c, Mesh_3_regular_triangulation_3_Vertex_handle ret) {
    CGAL_Mesh_3JNI.Mesh_3_regular_triangulation_3_nearest_power_vertex__SWIG_1(swigCPtr, this, Point_3.getCPtr(c), c, Mesh_3_regular_triangulation_3_Vertex_handle.getCPtr(ret), ret);
  }

  public Mesh_3_regular_triangulation_3_Vertex_handle nearest_power_vertex(Point_3 c1, Mesh_3_regular_triangulation_3_Cell_handle c2) {
    return new Mesh_3_regular_triangulation_3_Vertex_handle(CGAL_Mesh_3JNI.Mesh_3_regular_triangulation_3_nearest_power_vertex__SWIG_2(swigCPtr, this, Point_3.getCPtr(c1), c1, Mesh_3_regular_triangulation_3_Cell_handle.getCPtr(c2), c2), true);
  }

  public void nearest_power_vertex(Point_3 c1, Mesh_3_regular_triangulation_3_Cell_handle c2, Mesh_3_regular_triangulation_3_Vertex_handle ret) {
    CGAL_Mesh_3JNI.Mesh_3_regular_triangulation_3_nearest_power_vertex__SWIG_3(swigCPtr, this, Point_3.getCPtr(c1), c1, Mesh_3_regular_triangulation_3_Cell_handle.getCPtr(c2), c2, Mesh_3_regular_triangulation_3_Vertex_handle.getCPtr(ret), ret);
  }

  public Mesh_3_regular_triangulation_3_Vertex_handle nearest_power_vertex_in_cell(Point_3 c1, Mesh_3_regular_triangulation_3_Cell_handle c2) {
    return new Mesh_3_regular_triangulation_3_Vertex_handle(CGAL_Mesh_3JNI.Mesh_3_regular_triangulation_3_nearest_power_vertex_in_cell__SWIG_0(swigCPtr, this, Point_3.getCPtr(c1), c1, Mesh_3_regular_triangulation_3_Cell_handle.getCPtr(c2), c2), true);
  }

  public void nearest_power_vertex_in_cell(Point_3 c1, Mesh_3_regular_triangulation_3_Cell_handle c2, Mesh_3_regular_triangulation_3_Vertex_handle ret) {
    CGAL_Mesh_3JNI.Mesh_3_regular_triangulation_3_nearest_power_vertex_in_cell__SWIG_1(swigCPtr, this, Point_3.getCPtr(c1), c1, Mesh_3_regular_triangulation_3_Cell_handle.getCPtr(c2), c2, Mesh_3_regular_triangulation_3_Vertex_handle.getCPtr(ret), ret);
  }
  ...
  public Point_3 dual(Mesh_3_regular_triangulation_3_Cell_handle c) {
    return new Point_3(CGAL_Mesh_3JNI.Mesh_3_regular_triangulation_3_dual__SWIG_0(swigCPtr, this, Mesh_3_regular_triangulation_3_Cell_handle.getCPtr(c), c), true);
  }

  public void dual(Mesh_3_regular_triangulation_3_Cell_handle c, Point_3 ret) {
    CGAL_Mesh_3JNI.Mesh_3_regular_triangulation_3_dual__SWIG_1(swigCPtr, this, Mesh_3_regular_triangulation_3_Cell_handle.getCPtr(c), c, Point_3.getCPtr(ret), ret);
  }
