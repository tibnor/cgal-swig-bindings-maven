...
public class Regular_triangulation_3 extends Internal_Triangulation_3_Regular_triangulation_3 {
  ...
  public Regular_triangulation_3_Vertex_handle nearest_power_vertex(Point_3 c) {
    return new Regular_triangulation_3_Vertex_handle(CGAL_Triangulation_3JNI.Regular_triangulation_3_nearest_power_vertex__SWIG_0(swigCPtr, this, Point_3.getCPtr(c), c), true);
  }

  public void nearest_power_vertex(Point_3 c, Regular_triangulation_3_Vertex_handle ret) {
    CGAL_Triangulation_3JNI.Regular_triangulation_3_nearest_power_vertex__SWIG_1(swigCPtr, this, Point_3.getCPtr(c), c, Regular_triangulation_3_Vertex_handle.getCPtr(ret), ret);
  }

  public Regular_triangulation_3_Vertex_handle nearest_power_vertex(Point_3 c1, Regular_triangulation_3_Cell_handle c2) {
    return new Regular_triangulation_3_Vertex_handle(CGAL_Triangulation_3JNI.Regular_triangulation_3_nearest_power_vertex__SWIG_2(swigCPtr, this, Point_3.getCPtr(c1), c1, Regular_triangulation_3_Cell_handle.getCPtr(c2), c2), true);
  }

  public void nearest_power_vertex(Point_3 c1, Regular_triangulation_3_Cell_handle c2, Regular_triangulation_3_Vertex_handle ret) {
    CGAL_Triangulation_3JNI.Regular_triangulation_3_nearest_power_vertex__SWIG_3(swigCPtr, this, Point_3.getCPtr(c1), c1, Regular_triangulation_3_Cell_handle.getCPtr(c2), c2, Regular_triangulation_3_Vertex_handle.getCPtr(ret), ret);
  }

  public Regular_triangulation_3_Vertex_handle nearest_power_vertex_in_cell(Point_3 c1, Regular_triangulation_3_Cell_handle c2) {
    return new Regular_triangulation_3_Vertex_handle(CGAL_Triangulation_3JNI.Regular_triangulation_3_nearest_power_vertex_in_cell__SWIG_0(swigCPtr, this, Point_3.getCPtr(c1), c1, Regular_triangulation_3_Cell_handle.getCPtr(c2), c2), true);
  }

  public void nearest_power_vertex_in_cell(Point_3 c1, Regular_triangulation_3_Cell_handle c2, Regular_triangulation_3_Vertex_handle ret) {
    CGAL_Triangulation_3JNI.Regular_triangulation_3_nearest_power_vertex_in_cell__SWIG_1(swigCPtr, this, Point_3.getCPtr(c1), c1, Regular_triangulation_3_Cell_handle.getCPtr(c2), c2, Regular_triangulation_3_Vertex_handle.getCPtr(ret), ret);
  }
  ...
  public Point_3 dual(Regular_triangulation_3_Cell_handle c) {
    return new Point_3(CGAL_Triangulation_3JNI.Regular_triangulation_3_dual__SWIG_0(swigCPtr, this, Regular_triangulation_3_Cell_handle.getCPtr(c), c), true);
  }

  public void dual(Regular_triangulation_3_Cell_handle c, Point_3 ret) {
    CGAL_Triangulation_3JNI.Regular_triangulation_3_dual__SWIG_1(swigCPtr, this, Regular_triangulation_3_Cell_handle.getCPtr(c), c, Point_3.getCPtr(ret), ret);
  }
